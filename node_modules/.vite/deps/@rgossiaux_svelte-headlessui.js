...
var FocusTrap = class extends SvelteComponentDev {
  constructor(options) {
    ...
    if (
      /*containers*/
      ctx[2] === void 0 && !("containers" in props)
    ) {
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (switch_value !== (switch_value = /*as*/
      ctx2[1])) {
        if (switch_instance) {
          group_outros();
...
function instance27($$self, $$props, $$invalidate) {
  ...
  function handleWindowKeydown(event) {
    ...
    if (result === FocusResult.Underflow) {
      ...
      let nextElements = elements.splice(buttonIdx + 1).filter((element2) => !($panelStore == null ? void 0 : $panelStore.contains(element2)));
